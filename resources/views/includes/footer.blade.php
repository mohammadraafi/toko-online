<section class="h-100 w-100" style="box-sizing: border-box; background-color: #000000; margin-top: 200px">
    <style>
            ...
            <div class="row gap-md-0 gap-3">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <nav class="list-unstyled">
                        ...
                        <li class="list-space">
                            <a href="" class="list-menu">Budaya</a>
                        </li>
                        <li class="list-space">
                ...
                <div class="col-lg-3 col-md-6">
                    <h2 class="footer-text-title text-white">Bantuan</h2>
                    <nav class="list-unstyled">
                        <li class="list-space">
